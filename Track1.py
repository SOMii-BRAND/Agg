...
def login():
    os.system('clear')
    print logo1
    print "\033[1;91m[1]\x1b[1;97mSTART BANGLADESH( \033[1;92m NOW)"
    time.sleep(0.05)
...
def action():
    ...
    if peak =='':
        ...
        print 'Enter any code pak 1to49 bangla 175,165,191, 192, 193, 194, 195, 196, 197, 198, 199'
        print 'code choose '
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan("\033[0;95mBANGLADESH PAKISTAN CLONING") 
    jalan("\033[0;95mALL OLD IDS")
    jalan("\033[0;95mSOMI STAR BOY'")
    jalan("\033[0;95mWHATAAP")
    jalan("\033[0;93m03455453538")
...
\033[1;95myoutube\033[1;97mhttps://w ww.youtube.com/channel/sommi rapper"""
